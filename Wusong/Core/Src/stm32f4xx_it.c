...
void EXTI2_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(Hole_Left_Pin);
...
void EXTI3_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(Hole_Right_Pin);
...
void DMA1_Stream2_IRQHandler(void)
{
  ...
  RGB_FinishCallback(&Light, &hdma_tim3_ch4_up);
...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(KeyBoard0_Pin);
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(KeyBoard2_Pin);
  HAL_GPIO_EXTI_IRQHandler(KeyBoard1_Pin);
